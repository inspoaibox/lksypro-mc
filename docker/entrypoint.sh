...
for key in APP_ENV APP_DEBUG APP_URL DB_CONNECTION DB_HOST DB_PORT DB_DATABASE DB_USERNAME DB_PASSWORD CACHE_DRIVER QUEUE_CONNECTION SESSION_DRIVER SESSION_CONNECTION SESSION_DOMAIN SESSION_SECURE_COOKIE REDIS_HOST REDIS_PASSWORD REDIS_PORT; do
